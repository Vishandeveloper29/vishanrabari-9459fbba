...
export default function ThunderLoader({ onDone }) {
  ...
  const doBoltSequence = useCallback(
    (totalFlashes, onComplete) => {
    ...
    >
      <style>{`
        ...
        .vr-panel {
          ...
          transition: transform 1s cubic-bezier(.77,0,.18,1), opacity .8s ease;
        ...
        .vr-scan {
          ...
          background: linear-gradient(90deg, transparent, rgba(129,140,248,.7), rgba(56,189,248,.9), rgba(129,140,248,.7), transparent);
        ...
        .vr-crack-svg {
          ...
          pointer-events: none; z-index: 23; overflow: visible;
        ...
        .vr-behind {
          ...
          opacity: 0; transition: opacity .7s ease .15s; z-index: 5;
        }
        ...
        .vr-progress-bar {
          ...
          width: clamp(140px,25vw,200px); height: 2px;
          background: rgba(255,255,255,.08); border-radius: 999px; z-index: 35; overflow: hidden;
        }
        .vr-progress-fill {
          height: 100%;
      ...
      {/* CENTER CRACK LINE */}
      {!isSplit && (
        <div style={{ position:"absolute", top:0, left:"50%", transform:"translateX(-50%)", width:2, height:"100%", background: phase === "striking" ? "linear-gradient(to bottom,transparent,rgba(129,140,248,.6),rgba(56,189,248,.8),rgba(129,140,248,.6),transparent)" : "linear-gradient(to bottom,transparent,rgba(255,255,255,.06),transparent)", zIndex:20 }} />
      )}
      ...
      <svg
        ...
        style={{ position:"absolute", top:0, left:"50%", transform:"translateX(-50%)", width:24, height:"100%", zIndex:23, pointerEvents:"none", overflow:"visible" }}
      >
        <defs>
